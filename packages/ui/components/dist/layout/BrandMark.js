...
export function BrandMark({ logoOnly = false, size = "md", direction = "horizontal", className, src = "/kwasu-logo.png", alt = "Kwara State University logo", }) {
