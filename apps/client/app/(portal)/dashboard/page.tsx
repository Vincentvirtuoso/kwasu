...
const payments = [
  {
    id: "INV-2024-009",
    category: "2024/2025 School Fees",
    date: "14 Jan 2025",
    amount: 95000,
    status: "pending",
  },
  {
    id: "INV-2024-008",
    category: "2023/2024 School Fees",
    date: "20 Sep 2023",
    amount: 90000,
    status: "paid",
  },
  ...
  {
    id: "INV-2023-006",
    category: "2022/2023 School Fees",
    date: "10 Oct 2022",
    amount: 85000,
    status: "paid",
  },
...
const announcements = [
  ...
  {
    id: "2",
    title: "Course registration deadline extended to June 5",
    date: "Yesterday",
    urgent: false,
  },
  {
    id: "3",
    title: "Portal maintenance scheduled for Friday 11 PM",
    date: "2 days ago",
    urgent: false,
  },
];
  ...
  return (
    ...
    >
      <div
        style={{
          background:
            "linear-gradient(135deg, var(--color-green-900) 0%, var(--color-green-800) 100%)",
          borderRadius: 16,
          padding: "24px 28px",
          display: "flex",
          alignItems: "center",
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  paddingInline: 16,
                  borderLeft:
                    i > 0 ? "1px solid var(--color-cream-200)" : "none",
                }}
              >
                <div
                  style={{
          ...
          <div style={{ padding: "8px 8px 20px" }}>
            <ResponsiveContainer width="100%" height={220}>
              ...
              >
                ...
                />
                <Legend
                  formatter={(v) => (v === "gpa" ? "Your GPA" : "Dept Average")}
                  wrapperStyle={{
                    fontFamily: "var(--font-sans)",
                    fontSize: 12,
                    paddingTop: 8,
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {notifications.map((n) => (
              <div
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "var(--color-cream-50)")
                }
                onMouseLeave={(e) =>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    <span style={{ fontWeight: 700, color: "var(--fg-base)" }}>
                      {n.actor}
                    </span>{" "}
                    {n.action}
                  </p>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Complete record of your tuition and levy payments
              </p>
            </div>
            <Link
              href="/finance/fees"
            ...
            >
              View All <LuArrowUpRight size={13} />
            </Link>
          </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "var(--color-cream-50)" }}>
                {["Payment ID", "Category", "Date", "Amount", "Status", ""].map(
                  (h) => (
                    <th
                      key={h}
                      style={{
              ...
              >
                <div
                  style={{
                    marginTop: 2,
                    flexShrink: 0,
                    color: a.urgent ? "var(--color-danger)" : "var(--fg-muted)",
                  }}
                >
                  {a.urgent ? (
